...
host = neuroring.NeuroRingHost(net, 5632, 7000, 14, 2, param_dict, record_status, "/home/miahafiz/NeuroRing/_build_dir.hw.NUM_5632.CORE_7.FREQ_300/krnl_neuroring_hw.xclbin")
...
host.kernels_per_fpga[1][0].upload_synapse_list(host.synapse_fpga[7])
host.kernels_per_fpga[1][1].upload_synapse_list(host.synapse_fpga[8])
host.kernels_per_fpga[1][2].upload_synapse_list(host.synapse_fpga[9])
host.kernels_per_fpga[1][3].upload_synapse_list(host.synapse_fpga[10])
host.kernels_per_fpga[1][4].upload_synapse_list(host.synapse_fpga[11])
host.kernels_per_fpga[1][5].upload_synapse_list(host.synapse_fpga[12])
host.kernels_per_fpga[1][6].upload_synapse_list(host.synapse_fpga[13])
