...
class NeuroRingKernel:
    def __init__(self, simulation_time, threshold, membrane_potential, amount_of_cores, neuron_start, neuron_total, dcstim_start, dcstim_total, dcstim_amp, core_id, neuron_per_cu, synapse_total_per_cu, param_dict):
...
class NeuroRingHost:
    def __init__(self, net, neuron_per_cu, synapse_total_per_cu, num_compute_units, num_fpgas, param_dict, bitstream_file):
        self.net = net
        self.param_dict = param_dict
