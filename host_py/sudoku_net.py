...
inter_neuron_weight = -100.0  # inhibitory weight for synapses between neurons
weight_stim = 200.0  # weight from stimulation sources to neurons
weight_noise = 200.0  # weight for the background poisson generator
delay = 1.0  # delay for all synapses

neuron_params = {
    "C_m": 0.25,  # nF    membrane capacitance
    "I_e": 200.0,  # pA    bias current
