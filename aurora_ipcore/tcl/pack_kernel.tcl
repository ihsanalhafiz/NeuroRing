...
add_files -norecurse \
       {                                         \
              ../aurora_ipcore/rtl/krnl_aurora_control_s_axi.v \
              ../aurora_ipcore/rtl/krnl_aurora.v               \
...
add_files -norecurse -fileset constrs_1 \
       {                                         \
              ../aurora_ipcore/xdc/aurora_64b66b_0.xdc         \
       }
...
package_xo -force \
           -xo_path ../_x.hw.NUM_[lindex $argv 1].CORE_[lindex $argv 2].FREQ_[lindex $argv 3]/krnl_aurora.xo \
           -kernel_name krnl_aurora \
           -ctrl_protocol ap_ctrl_none \
           -ip_directory ./krnl_aurora_ip \
           -output_kernel_xml ../_x.hw.NUM_[lindex $argv 1].CORE_[lindex $argv 2].FREQ_[lindex $argv 3]/krnl_aurora.xml
